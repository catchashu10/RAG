...
def evaluate_with_ragas(data, output_file_name):
    '''
    data = {
        "user_input": List[str],
        "response": List[str],
    ...
    evaluator_llm = LangchainLLMWrapper(ChatOpenAI(model="gpt-3.5-turbo", temperature=0.0))  # should temperature really be 0.0?
